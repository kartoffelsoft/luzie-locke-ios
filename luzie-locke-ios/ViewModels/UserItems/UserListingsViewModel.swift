...
class UserListingsViewModel {
  ...
  private func fetchList() {
    ...
    let readList: (TimeInterval, @escaping (Result<(Array<Item>, Double), LLError>) -> ()) -> () = segment == 0 ? itemRepository.readListUserListings : itemRepository.readListUserListingsClosed
